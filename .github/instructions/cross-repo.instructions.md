---
description: Canonical FabricElements security & agent playbook for shared public packages.
applyTo: "src/**/*.ts,functions/src/**/*.ts,test/**/*.ts,**/*.md"
---

> **Canonical, replicated file.** This playbook is authored once and replicated verbatim
> across FabricElements public packages. Treat it as read-only here: fix it at the canonical
> source and re-replicate rather than editing this copy, so the packages cannot drift apart.
> Package-specific rules, and the `file:line` findings that motivated them, live in
