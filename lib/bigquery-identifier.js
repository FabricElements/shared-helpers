 ...
 * else in this module.
 */
export const bigQueryProjectPattern = /^[a-z][a-z0-9-]{4,28}[a-z0-9]$/;
/**
 ...
 */
export const validateBigQueryProject = (value, label) => {
    if (!value || !bigQueryProjectPattern.test(value)) {
 ...
 */
export const validateBigQueryDataset = (value, label) => {
 ...
 */
export const validateBigQueryTable = (value, label) => {
 ...
 */
export const validateBigQueryColumn = (value, label) => {
 ...
 */
export const validateBigQueryIdentifier = (value, label) => {
    if (!value || !bigQueryIdentifierPattern.test(value)) {
        throw new Error(`Invalid BigQuery identifier for ${label}: "${value}"`);
    }
};
export default validateBigQueryIdentifier;
//# sourceMappingURL=bigquery-identifier.js.map