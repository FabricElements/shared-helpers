 ...
 * @returns {string}
 */
exports.default = (phoneNumber, isMobile = false) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isValid = numberParsed ? libphonenumber_js_1.isValidNumber(baseNumber) : false;
        if (!isValid) {
