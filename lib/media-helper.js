        ...
        this.preview = (options) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (regex_js_1.contentTypeIsImageForSharp.test(contentType) && fileSize !== "max") {
                    ...
                    mediaBuffer = yield imageHelper.resize(Object.assign(Object.assign({}, imageResizeOptions), { fileName: mediaPath, format }));
            ...
            if (!ok) {
                ...
                mediaBuffer = yield imageHelper.resize(Object.assign({ fileName: "images/error.jpg" }, imageResizeOptions));
                contentType = "image/jpeg";
            }
            if (!mediaBuffer) {
                mediaBuffer = yield imageHelper.resize(Object.assign({ fileName: "images/default.jpg" }, imageResizeOptions));
                contentType = "image/jpeg";
                response.set("Cache-Control", "no-cache, no-store, s-maxage=10, max-age=10, min-fresh=5, must-revalidate");
            }
            else {
