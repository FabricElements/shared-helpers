 ...
 */
import { AvailableOutputFormats } from './media-formats.js';
 ...
 */
export const contentTypeIsImageForSharp = new RegExp(`^(image\\/)(${Object.keys(AvailableOutputFormats).join('|')})`); // Checks if will be image
/**
 * Regular expression that tests whether a MIME content-type string represents
