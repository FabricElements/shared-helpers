...
const variables_1 = require("../functions/src/helpers/variables");
...
class UserHelper {
    constructor(config) {
        ...
        this.getRole = (uid, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            const userClaims = (_a = userRecord.customClaims) !== null && _a !== void 0 ? _a : {};
            let role = (_b = userClaims.role) !== null && _b !== void 0 ? _b : null;
        ...
        this.update = (options) => {
            ...
            const imageHelper = new image_helper_1.ImageHelper({
                firebaseConfig: variables_1.firebaseConfig,
                isBeta: variables_1.isBeta,
            });
            const mediaHelper = new media_helper_1.MediaHelper({
                firebaseConfig: variables_1.firebaseConfig,
                isBeta: variables_1.isBeta,
            });
            let { context, data } = options;
            ...
            try {
                ...
                if (avatar) {
                    ...
                    const avatarUrl = `${variables_1.mainUrl}/avatar/${uid}`;
                ...
                yield ref.set(Object.assign(Object.assign({}, updateDataFirestore), { updated: timestamp }), { merge: true });
            }
            catch (error) {
        ...
        this.roleUpdateCall = (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            let _role = (_c = data.role) !== null && _c !== void 0 ? _c : "user";
            if (data.admin && data.uid) {
                ...
                let userClaims = (_d = userRecord.customClaims) !== null && _d !== void 0 ? _d : {};
                if (data.type === "remove") {
