...
class UserHelper {
    ...
    constructor() {
        ...
        this.create = (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            let user = yield this.exists(data);
            if (!user) {
         ...
         * @param data
         */
        this.exists = (data) => __awaiter(this, void 0, void 0, function* () {
            UserHelper.hasPhoneOrEmail(data);
            let _user = null;
            try {
                if (data.phone) {
                    _user = yield admin.auth().getUserByPhoneNumber(data.phone);
                }
                else if (data.email) {
        ...
        this.update = (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (data.admin) {
                userData = Object.assign(Object.assign({}, userData), { admin: data.type === "add" });
            }
