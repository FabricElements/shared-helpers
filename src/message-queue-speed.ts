 ...
 * deployment.
 *
 * @param options - Optional configuration overrides for the speed calculation.
 * @param options.instances - Number of concurrent function instances.
 *   Defaults to `1`.
 * @param options.sleep - Per-message sleep time in milliseconds added on top
 *   of the fixed 400 ms execution time estimate.  Defaults to `40`.
 * @param options.time - Total available time window in seconds over which the
